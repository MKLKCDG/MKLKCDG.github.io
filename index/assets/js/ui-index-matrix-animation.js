    ...
    // const rgb = "#007B80";
    // const rgbBright = "#1FDAE0";
    // const rgbHead = ["#F0FEFF", "#D1EFF0", "#80BDBF", "#3FACB0"];
    // const rgbTail = ["#000505", "#002F30", "#004C4F", "#006C70"];

    const rgb = "#009E8E";
    const rgbBright = "#2AEAD7";
    const rgbHead = ["#F1FFFD", "#D1F5F1", "#7ED3CA", "#38CDBE"];
    const rgbTail = ["#002D2D", "#00534C", "#006F64", "#009082"];
    ...
    requestAnimationFrame(init);// JavaScript Document